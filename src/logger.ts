...
export class Logger {
	...
	private readonly outputChannel = lazy(() => vscode.window.createOutputChannel('GIFT'));
	...
	private readTrace(): Trace {
		return Trace.fromString(vscode.workspace.getConfiguration().get<string>('gift.trace', 'off'));
	}
